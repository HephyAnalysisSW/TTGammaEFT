#!/bin/sh
python nanoPostProcessing.py --skim inclusive --year 2016 --processingEra TTGammaEFT_PP_2016_TTG_private_v46 --fileBasedSplitting --flagTTGamma --isTopSample --sample TTGHad_LO #SPLIT10
python nanoPostProcessing.py --skim inclusive --year 2016 --processingEra TTGammaEFT_PP_2016_TTG_private_v46 --fileBasedSplitting --flagTTGamma --isTopSample --sample TTGSingleLep_LO #SPLIT14
python nanoPostProcessing.py --skim inclusive --year 2016 --processingEra TTGammaEFT_PP_2016_TTG_private_v46 --fileBasedSplitting --flagTTGamma --isTopSample --sample TTGLep_LO #SPLIT5
python nanoPostProcessing.py --skim inclusive --year 2016 --processingEra TTGammaEFT_PP_2016_TTG_private_v46 --fileBasedSplitting --flagTTBar --isTopSample --sample TTLep_pow_CP5 #SPLIT40
python nanoPostProcessing.py --skim inclusive --year 2016 --processingEra TTGammaEFT_PP_2016_TTG_private_v46 --fileBasedSplitting --flagTTBar --isTopSample --sample TTSingleLep_pow_CP5 #SPLIT55
python nanoPostProcessing.py --skim inclusive --year 2016 --processingEra TTGammaEFT_PP_2016_TTG_private_v46 --fileBasedSplitting --flagTTBar --isTopSample --sample TTHad_pow_CP5 #SPLIT55
