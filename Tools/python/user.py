...
if os.environ["USER"] in ["lukas.lechner"]: #CBE cluster
    tmp_directory                       = "/scratch-cbe/users/lukas.lechner/tmp/TTGammaEFT/"
    results_directory                   = "/eos/vbc/user/lukas.lechner/TTGammaEFT/results/"

    mva_directory                       = "/eos/vbc/user/lukas.lechner/TTGammaEFT/mva/"
