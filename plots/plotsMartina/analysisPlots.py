...
# Sample definition
mc = [ mc_samples.TTG, mc_samples.TT_pow, mc_samples.singleTop, mc_samples.DY_LO, mc_samples.WJets, mc_samples.WG, mc_samples.ZG, mc_samples.rest ]
...
plotList.append( Plot(
    ...
    binning   = [ 20, 20, 300 ], # 20 bins from 20 to 400
))
plotList.append( Plot(
    name      = 'PhotonGood0_phi', # name of the plot file
    texX      = 'phi(#gamma_{0})', # x axis label
    texY      = 'Number of Events', # y axis label
    attribute = lambda event, sample: event.PhotonGood0_phi, # variable to plot
    binning   = [ 10, -pi, pi ],
))
plotList.append( Plot(
...
plotList.append( Plot(
    ...
    texX      = 'pt(#gamma_{0})',
    texY      = 'Number of Events',
    attribute = lambda event, sample: event.Bj0_pt,
    binning   = [ 20, 20, 300],
))
plotList.append( Plot(
    name      = 'Bj0_eta',
    texX      = '#eta(#gamma_{0})',
    texY      = 'Number of Events',
    attribute = lambda event, sample: event.Bj0_eta,
    binning   = [ 10, -2.5, 2.5 ],
))
plotList.append( Plot(
    name      = 'Bj0_phi',
    texX      = '#phi(#gamma_{0})',
    texY      = 'Number of Events',
    attribute = lambda event, sample: event.Bj0_phi,
    binning   = [ 10, -pi, -pi ],
))
plotList.append( Plot(
    name      = 'JetGood0_pt',
