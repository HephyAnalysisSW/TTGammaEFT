...
def drawPlots( plots ):
    ...
    for plot in plots:
        ...
        for log in [True, False]:
            plot_directory_ = os.path.join( plot_directory, 'testPlots', 'ctZ=2,ctZI=2', str(args.year), args.plot_directory, args.selection, args.mode, "log" if log else "lin" )
            plotting.draw( plot,
...
plotList.append( Plot(
    name      = 'GenPhotonCMSUnfold0_pt_smweight', # name of the plot file
