...
# particle level
    { 'name':"fiducial ==1 photon > 20 GeV",'texName':'$\\Ng^{\\textrm{fid}}=1$ with $\\pTG>20~\\GeV$',  'selectionString':"overlapRemoval==1&&nGenPhotonCMSUnfold==1",    "weightString":weight_at_gen},
