...
# particle level
    ...
    { 'name':"fiducial >=4 Jets",             'selectionString':"overlapRemoval==1&&nGenJetsCMSUnfold>=4&&nGenPhotonCMSUnfold==1&&nGenLeptonCMSUnfold==1", "weightString":weight_at_gen, 'prefix':'  '},
    ] 
