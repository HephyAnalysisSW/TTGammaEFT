...
# particle level
    ...
    { 'name':"fiducial >=4 Jets",             'selectionString':"overlapRemoval==1&&nGenJetsCMSUnfold>=4&&nGenPhotonCMSUnfold==1&&nGenLeptonCMSUnfold==1", "weightString":"weight"},
    ] 
...
entries += [
    ...
    { 'name':"(no fid.) reco trigger 1e||1mu",       'selectionString':"("+triggerSelector.SingleMuon+"||"+triggerSelector.SingleElectron+")", "weightString":"weight*reweightPU*reweightTrigger"},
    { 'name':"(no fid.) reco trigger 1 e",           'selectionString':triggerSelector.SingleElectron, "weightString":"weight*reweightPU*reweightTrigger", 'prefix' : "  "},
    { 'name':"(no fid.) reco trigger 1 mu",          'selectionString':triggerSelector.SingleMuon, "weightString":"weight*reweightPU*reweightTrigger", 'prefix' : "  "},
    { 'name':"(no fid.) reco == 1 tight lep",        'selectionString':"nLeptonTight==1&&triggered", "weightString":"weight*reweightLeptonTightSF*reweightLeptonTrackingTightSF*reweightPU*reweightTrigger"},
    { 'name':"(no fid.) reco == 1 tight mu",         'selectionString':"nLeptonTight==1&&triggered&&abs(LeptonTight0_pdgId)==13", "weightString":"weight*reweightLeptonTightSF*reweightLeptonTrackingTightSF*reweightPU*reweightTrigger", 'prefix' : "  "},
    { 'name':"(no fid.) reco == 1 tight e",          'selectionString':"nLeptonTight==1&&triggered&&abs(LeptonTight0_pdgId)==11", "weightString":"weight*reweightLeptonTightSF*reweightLeptonTrackingTightSF*reweightPU*reweightTrigger", 'prefix' : "  "},
    { 'name':"(no fid.) reco extra leptonVeto",      'selectionString':"nLeptonTight==1&&triggered&&nLeptonVetoIsoCorr==1", "weightString":"weight*reweightLeptonTightSF*reweightLeptonTrackingTightSF*reweightPU*reweightTrigger"},
    { 'name':"(no fid.) reco MET filters",           'selectionString':MET_filter_cut+"&&nLeptonTight==1&&triggered&&nLeptonVetoIsoCorr==1", "weightString":"weight*reweightLeptonTightSF*reweightLeptonTrackingTightSF*reweightPU*reweightTrigger"},
    { 'name':"(no fid.) reco HEM",                   'selectionString':MET_filter_cut+"&&nLeptonTight==1&&triggered&&nLeptonVetoIsoCorr==1", "weightString":"weight*reweightLeptonTightSF*reweightLeptonTrackingTightSF*reweightPU*reweightTrigger*reweightHEM"},
    { 'name':"(no fid.) reco L1Prefire",             'selectionString':MET_filter_cut+"&&nLeptonTight==1&&triggered&&nLeptonVetoIsoCorr==1", "weightString":"weight*reweightLeptonTightSF*reweightLeptonTrackingTightSF*reweightPU*reweightTrigger*reweightHEM*reweightL1Prefire"},
    { 'name':"(no fid.) reco ==1 photon",   'selectionString':MET_filter_cut+"&&nLeptonTight==1&&triggered&&nLeptonVetoIsoCorr==1&&nPhotonGood==1", "weightString":"weight*reweightPhotonSF*reweightPhotonElectronVetoSF*reweightLeptonTightSF*reweightLeptonTrackingTightSF*reweightPU*reweightTrigger*reweightHEM*reweightL1Prefire"},
