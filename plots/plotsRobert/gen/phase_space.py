...
entries += [
#    { 'name':"(no fid.) reco trigger 1e||1mu",       'selectionString':"("+triggerSelector.SingleMuon+"||"+triggerSelector.SingleElectron+")", "weightString":weight_at_gen+"*reweightPU*reweightTrigger"},
#    { 'name':"(no fid.) reco trigger 1e||1mu",       'selectionString':"("+triggerSelector.SingleMuon+"||"+triggerSelector.SingleElectron+")", "weightString":weight_at_gen+"*reweightPU*reweightTrigger"},
#    { 'name':"(no fid.) reco trigger 1 e",           'selectionString':triggerSelector.SingleElectron, "weightString":weight_at_gen+"*reweightPU*reweightTrigger", 'prefix' : "  "},
#    { 'name':"(no fid.) reco trigger 1 mu",          'selectionString':triggerSelector.SingleMuon, "weightString":weight_at_gen+"*reweightPU*reweightTrigger", 'prefix' : "  "},
#    { 'name':"(no fid.) reco == 1 tight lep",        'selectionString':"nLeptonTight==1&&triggered", "weightString":weight_at_gen+"*reweightLeptonTightSF*reweightLeptonTrackingTightSF*reweightPU*reweightTrigger"},
#    { 'name':"(no fid.) reco == 1 tight mu",         'selectionString':"nLeptonTight==1&&triggered&&abs(LeptonTight0_pdgId)==13", "weightString":weight_at_gen+"*reweightLeptonTightSF*reweightLeptonTrackingTightSF*reweightPU*reweightTrigger", 'prefix' : "  "},
#    { 'name':"(no fid.) reco == 1 tight e",          'selectionString':"nLeptonTight==1&&triggered&&abs(LeptonTight0_pdgId)==11", "weightString":weight_at_gen+"*reweightLeptonTightSF*reweightLeptonTrackingTightSF*reweightPU*reweightTrigger", 'prefix' : "  "},
#    { 'name':"(no fid.) reco extra leptonVeto",      'selectionString':"nLeptonTight==1&&triggered&&nLeptonVetoIsoCorr==1", "weightString":weight_at_gen+"*reweightLeptonTightSF*reweightLeptonTrackingTightSF*reweightPU*reweightTrigger"},
#    { 'name':"(no fid.) reco MET filters",           'selectionString':MET_filter_cut+"&&nLeptonTight==1&&triggered&&nLeptonVetoIsoCorr==1", "weightString":weight_at_gen+"*reweightLeptonTightSF*reweightLeptonTrackingTightSF*reweightPU*reweightTrigger"},
#    { 'name':"(no fid.) reco HEM",                   'selectionString':MET_filter_cut+"&&nLeptonTight==1&&triggered&&nLeptonVetoIsoCorr==1", "weightString":weight_at_gen+"*reweightLeptonTightSF*reweightLeptonTrackingTightSF*reweightPU*reweightTrigger*reweightHEM"},
#    { 'name':"(no fid.) reco L1Prefire",             'selectionString':MET_filter_cut+"&&nLeptonTight==1&&triggered&&nLeptonVetoIsoCorr==1", "weightString":weight_at_gen+"*reweightLeptonTightSF*reweightLeptonTrackingTightSF*reweightPU*reweightTrigger*reweightHEM*reweightL1Prefire"},
#    { 'name':"(no fid.) reco ==1 photon",   'selectionString':MET_filter_cut+"&&nLeptonTight==1&&triggered&&nLeptonVetoIsoCorr==1&&nPhotonGood==1", "weightString":weight_at_gen+"*reweightPhotonSF*reweightPhotonElectronVetoSF*reweightLeptonTightSF*reweightLeptonTrackingTightSF*reweightPU*reweightTrigger*reweightHEM*reweightL1Prefire"},
#    { 'name':"(no fid.) reco photon veto",           'selectionString':MET_filter_cut+"&&nLeptonTight==1&&triggered&&nLeptonVetoIsoCorr==1&&nPhotonGood==1&&nPhotonNoChgIsoNoSieie==1", "weightString":weight_at_gen+"*reweightPhotonSF*reweightPhotonElectronVetoSF*reweightLeptonTightSF*reweightLeptonTrackingTightSF*reweightPU*reweightTrigger*reweightHEM*reweightL1Prefire"},
    { 'name':"(no fid.) reco >=3 Jets",              'selectionString':MET_filter_cut+"&&nLeptonTight==1&&triggered&&nLeptonVetoIsoCorr==1&&nPhotonGood==1&&nPhotonNoChgIsoNoSieie==1&&nJetGood>=3", "weightString":weight_at_gen+"*reweightPhotonSF*reweightPhotonElectronVetoSF*reweightLeptonTightSF*reweightLeptonTrackingTightSF*reweightPU*reweightTrigger*reweightHEM*reweightL1Prefire"},
    { 'name':"(no fid., no weight) reco >=3 Jets",              'selectionString':MET_filter_cut+"&&nLeptonTight==1&&triggered&&nLeptonVetoIsoCorr==1&&nPhotonGood==1&&nPhotonNoChgIsoNoSieie==1&&nJetGood>=3", "weightString":"(1)"},
#    { 'name':"(no fid.) reco >=1 b-Jets",            'selectionString':MET_filter_cut+"&&nLeptonTight==1&&triggered&&nLeptonVetoIsoCorr==1&&nPhotonGood==1&&nPhotonNoChgIsoNoSieie==1&&nJetGood>=3&&nBTagGood>=1", "weightString":weight_at_gen+"*reweightPhotonSF*reweightPhotonElectronVetoSF*reweightLeptonTightSF*reweightLeptonTrackingTightSF*reweightPU*reweightTrigger*reweightHEM*reweightL1Prefire*reweightBTag_SF"},
#    { 'name':"(no fid.) reco >=4 Jets",              'selectionString':MET_filter_cut+"&&nLeptonTight==1&&triggered&&nLeptonVetoIsoCorr==1&&nPhotonGood==1&&nPhotonNoChgIsoNoSieie==1&&nJetGood>=4&&nBTagGood>=1", "weightString":weight_at_gen+"*reweightPhotonSF*reweightPhotonElectronVetoSF*reweightLeptonTightSF*reweightLeptonTrackingTightSF*reweightPU*reweightTrigger*reweightHEM*reweightL1Prefire*reweightBTag_SF"},
]
