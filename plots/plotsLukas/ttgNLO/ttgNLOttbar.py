...
colors = [[ROOT.kGreen-2], [ROOT.kRed, ROOT.kBlue]]
...
for i_m, mcl in enumerate(mc):
  for i,s in enumerate(mcl):
    ...
    if "TT_pow" in s.name:
        s.hist.legendText    = s.texName + "+tt#gamma (NLO)"
...
for plot in plots:
    ...
    for log in [True, False]:
        ...
        ratio = {'yRange':(0.51,1.49), "texY":"NLO/LO", "histModifications":ratioHistModifications, 'histos':[(0,1)]}
