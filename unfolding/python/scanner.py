...
# Wrapper classes for the TUnfold interface
# Taken fromhttps://github.com/raggleton/QGAnalysisPlotting/blob/master/unfolding_regularisation_classes.py
...
class TauScanner():
    ...
    def scan_tau(self, tunfolder, n_scan, tau_min, tau_max, scan_mode):
    ...
    def plot_scan_tau(self, output_dirname):
...
class LCurveScanner():
    ...
    def plot_scan_L_curve(self, output_dirname):
        """Plot graph of scan results, and optimum tau"""
    ...
    def plot_scan_L_curvature(self, output_dirname):
