...
try:
    ...
    postprocessing_directory_ = postprocessing_locations.MC2018
...
dirs['all_noOther']      = dirs['TTG'] + dirs['TT_pow'] + dirs['DY_LO'] + dirs['singleTop'] + dirs['ZG_lowMLL']
